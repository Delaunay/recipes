...
# -*- coding: utf-8 -*-
"""
recipes documentation build configuration file.
...
src_path = os.path.abspath(os.path.join(docs_src_path, '..', 'recipes'))
...
project = u'recipes'
_full_version = recipes.__version__
author = recipes.__author__
copyright = recipes.__copyright__
...
man_pages = [
    (master_doc, 'recipes', 'recipes Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'recipes', 'recipes Documentation',
     author, 'recipes', recipes.__descr__,
     'Miscellaneous'),
]
